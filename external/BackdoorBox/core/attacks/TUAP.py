...
import numpy as np
import copy
# from torch.autograd.gradcheck import zero_gradients  # 已在PyTorch 1.2+中移除
import torchvision
...
# 兼容性函数：替代已移除的zero_gradients
def zero_gradients(x):
    """
    兼容性函数，替代PyTorch中已移除的zero_gradients函数
    在PyTorch 1.2.0+中，zero_gradients已被移除
    """
